                ...
                for posembed in ['50']:
                    for lr in ['0.001', '0.0005']:
                        for lstmsize in ['100']:
                            ...
                            prefix += "python jNERE.py --dynet-seed 123456789 --dynet-mem 512 --epochs 50 --wembedding {} --cembedding {} --nembedding {} --pembedding {} --lr {} --lstmdims {}".format(wordembed, charembed, nerembed, posembed, lr, lstmsize)
                            writer.write(prefix)
